...
\textbf{Lösning}\\
Den kända linjen kan skrivas som $y = 2x$. Den sökta linjen kan skrivas på formen $y = 2x + m$ då den är parallell med den kända linjen. Vi kan få fram värdet av $m$ genom att vi sätter in den punkt som vi vet att linjen går genom.
