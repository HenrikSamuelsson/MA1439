...
\section*{Uppgift 3.}
\begin{enumerate}[(a)]
\item En andragradskurva har en minimipunkt då x = 5. Kurvan skär x-axeln då x = 7 och då x = a. Vilket är talet a?
\item Finn ett uttryck för en andragrads-funktion som uppfyller kraven i a-uppgiften.
\end{enumerate}
